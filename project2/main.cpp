...
void run2Electron(unsigned int MCCycles, unsigned int optCycles, int nParticles, int nDimensions, double omega, double alpha, double stepLength, double seed);
...
int main()
{
    ...
    run2Electron(MCCycles, optCycles, nParticles, nDimensions, omega, alpha, 1.31, seed);
